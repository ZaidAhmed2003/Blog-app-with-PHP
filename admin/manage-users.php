...
<section class="dashboard">
    <?php if (isset($_SESSION['add-user-success'])) : // Show if the user is added
    ?>
    ...
    <?php elseif (isset($_SESSION['edit-user-success'])) : // Show if the user is edited
    ?>
        <div class="container alert__message success">
            <p>
                <?=
    ...
    <?php elseif (isset($_SESSION['edit-user'])) : // Show if the user edit was not successful
    ?>
    ...
    <?php elseif (isset($_SESSION['delete-user'])) : // Show if the user delete was not succesful.
    ?>
        <div class="container alert__message error">
            <p>
                <?=
    ...
    <?php elseif (isset($_SESSION['delete-user-success'])) : // Show if the user delete was successful.
    ?>
