...
<section class="dashboard">
    <?php if (isset($_SESSION['add-category'])) : // Show if add category was not successful 
    ?>
    ...
    <?php elseif (isset($_SESSION['add-category-success'])) : // Show if add category was successful 
    ?>
    ...
    <?php elseif (isset($_SESSION['edit-category-success'])) : // Show if update category was successful 
    ?>
        <div class="alert__message success container">
            <p>
                <?=
    ...
    <?php elseif (isset($_SESSION['edit-category'])) : // Show if update category was not successful 
    ?>
        <div class="alert__message error container">
            <p>
                <?=
